			...
			<View style={{marginHorizontal:'5%'}}>
				...
				<Text style={styles.text2}>
					...
					<View style={{marginHorizontal:'5%', marginVertical:20}}>
						<PicButton source = {require('../../../assets/pic1.png')} text={'From Gallery'}/>
						<PicButton source = {require('../../../assets/camera.png')} text={'Take Photo'}/>
					</View>
		              
			</View>

			      <View style={{justifyContent:'center', alignItems:'center'}}>
			      	<GreenButton label = {'Next'} onPress={()=>navigation.navigate('BioPhoto2')}/>
			      </View>
			      </ScrollView>
			</ImageBackground>
